...
use mainBundle\Form\ServiceType;
...
class ServiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('mainBundle:Service')->findAll();
     ...
     * @Method("POST")
     * @Template("mainBundle:Service:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('mainBundle:Service')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("mainBundle:Service:edit.html.twig")
     */
